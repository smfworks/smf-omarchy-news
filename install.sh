#!/bin/bash
# One-shot SMF Omarchy News install for Hermes Desktop.
#
...
REPO="${REPO:-https://github.com/smfworks/smf-omarchy-news.git}"
NAME=smf-omarchy-news
...
echo "Then: Ctrl+K → Open Omarchy News."
